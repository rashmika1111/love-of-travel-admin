...
function Toolbar() {
  return (
    <div className="container-fluid py-2.5 lg:py-7.5 flex flex-wrap items-center justify-between gap-2.5 shrink-0">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <Button className="bg-[#0B5C22] hover:bg-[#0B5C22]/90"><Plus /> Add</Button>
      </div>
    </div>
  );
}
