    ...
    children: [
      { title: 'Dashboard', path: '/layout-1/blog/dashboard' },
      {
        ...
        children: [
          ...
          { title: 'New Posts', path: '/layout-1/blog/posts/new' },
      ...
      },
      {
        ...
        children: [
          { title: 'All Users', path: '/layout-1/blog/users' },
          { title: 'Role Management', path: '/layout-1/blog/users/roles' },
          { title: 'User Activity', path: '/layout-1/blog/users/activity' },
        ],
      },
      {
        title: 'Moderation',
        children: [
          { title: 'Comment Queue', path: '/layout-1/blog/comments' },
          { title: 'Reported Content', path: '/layout-1/blog/comments/reported' },
          { title: 'Spam Management', path: '/layout-1/blog/comments/spam' },
        ],
      },
      {
        ...
        children: [
          ...
          { title: 'Content Analytics', path: '/layout-1/blog/analytics' },
          { title: 'Ad Performance', path: '/layout-1/blog/ads' },
        ],
      },
    ],
  },
